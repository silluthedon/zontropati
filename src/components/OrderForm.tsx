...
import { Trash2 } from 'lucide-react'; // নতুন আইকন ইম্পোর্ট করুন
...
const schema = yup.object().shape({
  ...
  // productId এবং quantity এখন কার্ট থেকে আসবে, তাই ফর্ম থেকে সরিয়ে দেওয়া হয়েছে।
});
...
const OrderForm: React.FC<OrderFormProps> = ({ cart, setCart }) => {
  ...
  const onSubmit = async (data: OrderFormData) => {
    ...
    setSubmitting(true);
    try {
      // কার্টের প্রতিটি আইটেমের জন্য ডেটাবেসে একটি করে অর্ডার যুক্ত করা হচ্ছে
      ...
      reset();
      setCart([]); // অর্ডার সফল হলে কার্ট খালি করুন
    } catch (error) {
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Fill out the form below to order your car tools
            </p>
          </div>

          <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-200">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              {/* ... অন্যান্য ফর্ম ফিল্ড এখানে থাকবে, যেমন নাম, ইমেইল ইত্যাদি */}
              ...
              {/* এখানে কার্ট লিস্ট দেখানো হয়েছে */}
              <div className="mt-8">
